...
import com.facebook.shuiai.project.util.FileUtil;
...
public abstract class BaseRequest<T extends BaseRequest> {
    ...
    public T cancleDialoge(boolean isdialogeCanCancle) {
        this.isdialogeCanCancle = isdialogeCanCancle;
        return (T) this;
    }

    public T dialogInfo(String dialogShowInfo) {
        this.dialogShowInfo = dialogShowInfo;
        return (T) this;
    }
}
